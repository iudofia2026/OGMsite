...
const signatureStyles = `
  ...
  .signature-path-1 {
    animation: revealSignature 1s ease-out 3.5s forwards;
  }

  .signature-path-2 {
    animation: revealSignature 3s ease-out 1.8s forwards;
  }

  .signature-path-3 {
    animation: revealSignature 1.5s ease-out 1.5s forwards;
  }
