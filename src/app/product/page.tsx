...
export default function ProductPage() {
  useEffect(() => {
    // Wait for Swiper library to load, then initialize
    const initSwiper = () => {
      // @ts-ignore
      if (typeof Swiper !== 'undefined') {
        ...
        // If Swiper not loaded yet, try again in 100ms
          ...
          <div className="main-wrapper swiper-wrapper">
            ...
            <div className="main swiper-slide" id="coral">
              <div className="left-side">
                ...
                <div className="main-content">
                  <div className="main-content__title">We will have lost 60% of our coral reefs by 2030.</div>
                  <div className="main-content__subtitle">Coral reefs are essential to humans, as they protect the shorelines and are a source of nutrients and habitat for thousands of marine species.</div>
                  <div className="more-menu">
                    Shop Now
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" strokeWidth="1.7" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                      <path stroke="none" d="M0 0h24v24H0z" fill="none" />
